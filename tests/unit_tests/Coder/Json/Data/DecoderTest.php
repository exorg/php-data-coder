...
{
    const DECODER_FULLY_QUALIFIED_CLASS_NAME = 'ExOrg\DataCoder\Coder\Json\Data\Decoder';
     ...
     * @var Decoder
     */
    private Decoder $jsonDataDecoder;

    /**
     * Test Json Data Decoder class
     * has been created.
     */
    ...
    {
        $this->jsonDataDecoder = new Decoder();
    }
}
